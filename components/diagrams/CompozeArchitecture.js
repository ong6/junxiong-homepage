...
export function Wide({ id }) {
	return (
		<>
			...
			<Line id={id} x1={936} y1={256} x2={1000} y2={256} accent />
			<Label x={968} y={248} text="llm call" anchor="middle" accent size={10} />

			<Line id={id} x1={680} y1={432} x2={680} y2={496} accent />
			<Label x={664} y={470} text="cosine · floor 0.35" anchor="end" accent size={11} />
			<Line id={id} x1={752} y1={496} x2={752} y2={432} accent />
			...
			<Flow x1={296} y1={256} x2={360} y2={256} kind="change" dur={1.8} />
			<Flow x1={936} y1={256} x2={1000} y2={256} kind="request" dur={1.6} />
			<Flow x1={936} y1={256} x2={1000} y2={256} kind="response" dur={1.6} delay={-0.8} reverse />
			<Flow x1={680} y1={432} x2={680} y2={496} kind="request" dur={1.6} />
			<Flow x1={752} y1={496} x2={752} y2={432} kind="response" dur={1.6} delay={-0.8} />
			<Packet
				points={[
					[448, 432],
					[448, 464],
...
export function Narrow({ id }) {
	...
	return (
		<>
			...
			<Line id={id} x1={100} y1={736} x2={100} y2={688} accent />
			<Label x={92} y={716} text="floor 0.35" anchor="end" accent size={10} />
			<Line id={id} x1={260} y1={688} x2={260} y2={736} accent />
			...
			<Line id={id} x1={180} y1={1004} x2={180} y2={1052} accent />
			...
			<Flow x1={180} y1={180} x2={180} y2={228} kind="change" dur={1.4} />
			<Flow x1={180} y1={440} x2={180} y2={488} kind="change" dur={1.4} delay={-0.7} />
			<Flow x1={100} y1={736} x2={100} y2={688} kind="request" dur={1.4} />
			<Flow x1={260} y1={688} x2={260} y2={736} kind="response" dur={1.4} delay={-0.7} />
			<Flow x1={180} y1={1004} x2={180} y2={1052} kind="request" dur={1.4} />
			<Flow x1={180} y1={1004} x2={180} y2={1052} kind="response" dur={1.4} delay={-0.7} reverse />
		</>
	);
}
