...
export const hobbyScenePalettes = {
	...
	dark: { accent: 0x9ab6ff, ink: 0x353c49, muted: 0x919aab, paper: 0xe4e7ed },
};

// Colours key off the data-theme attribute that ColorModeScript writes before
// first paint. mode() would bake the server's light guess into the SSR CSS and
// flash light on dark-mode visits until hydration.
const styles = {
	global: {
		":root": {
			colorScheme: "light",
		...
		"html[data-theme=dark] body": { bg: "#151311", color: "#F2ECE3" },
		"::selection": { bg: "#BFCFFF", color: "#151311" },
		"html[data-theme=dark] ::selection": { bg: "#315DB6", color: "#FBF8F2" },
	},
};
